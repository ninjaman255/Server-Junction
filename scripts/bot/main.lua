...
--[[function handle_player_join(player_id)
  if table.PlayerCheck == {1} and table.PlayerCheck == {player_id} then
return
  else if table.PlayerCheck == {0} and table.PlayerCheck == {player_id} then
    Net.message_player(player_id, "Ahead are Server warps, Please feel free to use this junction as much as you wish!", "/server/assets/mugs/prog.png", "/server/assets/mugs/prog_mug.animation")
    table.PlayerCheck = {player_id,1}
end
end
end--]]
